        ...
        <div>
            <div className="container">
                ...
                <div className=" grid grid-cols-3 gap-3">
                    {cats && cats?.map((cat) => {
                        return (
                            <NavLink to={`/yaslar/detail/${cat?.id}`} className='bg-[#fafafa] cursor-pointer w-full aspect-[4/3] flex justify-between flex-col  p-5 text-black font-semibold aspect-video'>
