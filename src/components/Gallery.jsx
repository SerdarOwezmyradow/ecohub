    ...
    return (
        <div className='mb-20'>
            ...
            <motion.div
                ...
                className="flex justify-between max-w-[1900px] mx-auto  items-center">
                    ...
                    {cats?.map((cat, index) => {
                        return (
                            <SwiperSlide className='mt-10 cursor-pointer'>
                                ...
                                {cat.type == 2 &&
                                    <div className='w-full aspect-[4/3]'>
                                        <video  onClick={() => OpenImage(index)} className='w-full h-full object-cover' alt="" >
                                            <source src={`${baseUrl}/storage/upload/gallery/videos/${cat?.video}`} />
                                        </video>
                                    </div>
                                }
                            </SwiperSlide>
                    ...
                    <div className="">
                        ...
                        {cats && cats[selectedImage] &&
                            <div className="flex justify-between gap-2  items-center mx-5 h-[100vh]">
                                ...
                                {cats[selectedImage]?.type == 1 &&
                                    <img className=' w-3/4 ' src={`${baseUrl}/storage/upload/gallery/images/${cats[selectedImage]?.photo}`} alt="" />
                                }
                                {cats[selectedImage]?.type == 2 &&
                                    <video className=' w-3/4 ' controls>
                                        <source src={`${baseUrl}/storage/upload/gallery/videos/${cats[selectedImage]?.video}`} />
                                        {/* Add other video types if necessary */}
