    ...
    return (
        <div className='bg-[#FAFAFA] cursor-pointer font-semibold p-4 relative w-full aspect-video'>
            ...
            <div className='absolute bottom-4 left-4 right-4'>
                <span className='text-sm text-goldColor'>Ady Familýasy</span>
                <div className='text-darkColor line-clamp-2 w-full'>Türkmenistan sanly ulgamyň mümkinçiliklerine daýanýar</div>
            </div>
